const library = "https://jjbaquote-library.json"; //les listes JSON s'écrivent ainsi, une liste d'objet entre [] , et chaque objet entre {} pour chacune des entrées de cet objet (ex: nom, âge, poids) balise et valeur sont chacune entre parenthèses, séparés par : et une virgule pour l'entrée suivante, ne pas en mettre à la dernière, mais pour mettre un prochain objet, mettre une virgule après la } terminant l'objet précédent
